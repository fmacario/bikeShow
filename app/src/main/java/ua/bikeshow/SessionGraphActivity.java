...
public class SessionGraphActivity extends AppCompatActivity {
   ...
   // DatabaseReference mySess = database.getReference().child("values").child(user).child("20180323112917");
    ...
    private void initialize(){
        ...
        date1.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                Log.e(SessionGraphActivity.this.toString(), "onCancelled", databaseError.toException());
            }
        });
